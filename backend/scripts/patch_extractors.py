...
# 1. Update document_classifier.py (Remove YOLO logic)
classifier_path = r"C:\Users\A Syed Khwaja\OneDrive\Desktop\Zampify-AI\backend\app\services\document_classifier.py"
with open(classifier_path, "r", encoding="utf-8") as f:
    content = f.read()

new_classify_func = """def classify_pdf(pdf_path: str) -> ClassificationResult:
    \"\"\"
    ...
    try:
        ...
        raise
"""
# Replace from `def classify_pdf` to end of file
start_idx = content.find("def classify_pdf")
if start_idx != -1:
    content = content[:start_idx] + new_classify_func

with open(classifier_path, "w", encoding="utf-8") as f:
    f.write(content)


# 2. Update text_extractor.py to return DocumentIntelligencePackage with coordinate-tagged text
extractor_path = r"C:\Users\A Syed Khwaja\OneDrive\Desktop\Zampify-AI\backend\app\services\text_extractor.py"
...
print("Patched text_extractor.py and document_classifier.py")
