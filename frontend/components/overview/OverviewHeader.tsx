  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Real-time overview of accounts payable operations and team performance.</p>
      </div>
      ...
      <div className="flex items-center gap-3 mt-4 md:mt-0">
        ...
        <button className="flex items-center gap-2 bg-white border border-slate-200 text-slate-700 px-4 py-1.5 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors shadow-sm h-[36px] mt-4">
