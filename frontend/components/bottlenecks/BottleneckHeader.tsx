...
export default function BottleneckHeader() {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Bottleneck Heatmap</h1>
        <p className="text-sm text-slate-500 mt-1">Visualize process delays and identify performance bottlenecks across the AP workflow.</p>
      </div>
