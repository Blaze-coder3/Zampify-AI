...
export default function TopVendorsFinancial({ data }: { data: any[] }) {
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-slate-100">
              ...
              <th className="pb-3 px-2 text-[10px] font-semibold text-slate-400 uppercase tracking-wider text-center">Total Spend (USD)</th>
              <th className="pb-3 px-2 text-[10px] font-semibold text-slate-400 uppercase tracking-wider text-center">% of Total Spend</th>
