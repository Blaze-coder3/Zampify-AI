  ...
  return (
    <div className="flex flex-wrap items-center gap-3 mb-5">
      <div className="relative">
        ...
        <input type="text" placeholder="Search users..." className="pl-8 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-700 focus:outline-none focus:ring-1 focus:ring-blue-400 w-40" />
      </div>
      {["All Roles", "All Departments", "All Status"].map(label => (
